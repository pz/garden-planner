/** Stroke icons from the layout editor design (Lucide-style, 24×24 grid). */
const ICONS = {
  select: ['M4.037 4.688a.495.495 0 0 1 .651-.651l16 6.5a.5.5 0 0 1-.063.947l-6.124 1.58a2 2 0 0 0-1.438 1.435l-1.579 6.126a.5.5 0 0 1-.947.063z'],
  ...
  ruler: [
    ...
    'm14.5 12.5 2-2m-5-1 2-2m-5-1 2-2m7 11 2-2',
  ],
  ...
  fit: ['M3 7V5a2 2 0 0 1 2-2h2M17 3h2a2 2 0 0 1 2 2v2M21 17v2a2 2 0 0 1-2 2h-2M7 21H5a2 2 0 0 1-2-2v-2'],
} as const;
